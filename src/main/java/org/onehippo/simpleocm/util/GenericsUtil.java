...
package org.onehippo.simpleocm.util;
...
public final class GenericsUtil {
    ...
    public static <T> void setPropertyValues(final Property property, final Collection<T> values) throws RepositoryException {
        ...
        int index = 0;
        for (T object : values) {
            newValues[index++] = createValue(property, object);
        }
    ...
    public static <T> void setPropertyValues(final Node node, final String relativePath, final Collection<T> values) throws RepositoryException {
        ...
        if (values == null) {
            ...
            for (T object : values) {
                newValues.add(createValue(node, object));
            }
            node.setProperty(relativePath, newValues.toArray(new Value[newValues.size()]));
        }
    }

//    public static Value createValue(Item item, Object object) throws RepositoryException {
//        ValueFactory valueFactory = item.getSession().getValueFactory();
//        if (object instanceof String) {
//            return valueFactory.createValue((String)object);
//        } else if (object instanceof Long) {
//            return valueFactory.createValue((Long) object);
//        } else if (object instanceof Double) {
//            return valueFactory.createValue((Double) object);
//        } else if (object instanceof Calendar) {
//            return valueFactory.createValue((Calendar) object);
//        } else if (object instanceof Boolean) {
//            return valueFactory.createValue((Boolean) object);
//        }
//        throw new UnsupportedOperationException("Create value doesn't support the type '" + object.getClass() + "'");
//    }
    // TODO
    public static Value createValue(Item item, Object object) {
        if (object instanceof String) {
